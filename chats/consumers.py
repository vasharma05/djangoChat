...
class GroupChatConsumer(WebsocketConsumer):
    ...
    def check_room(self):
        ...
        if self.room_name in models.Room.objects.filter(group=True).values_list('name', flat=True):
            self.room = models.Room.objects.get(name=self.room_name)
        else:
            self.room = models.Room.objects.create(name=self.room_name, group=True)
